...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-void-950/95 backdrop-blur-xl border-b border-void-800/80 flex flex-col">
      ...
      <div className="w-full h-14 sm:h-16 px-3 sm:px-4 md:px-8 flex items-center justify-between relative">
        {/* Brand Logo & Title */}
        <div
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
          ...
          <div className="flex items-center gap-1.5 bg-void-900 border border-purple-500/30 px-2.5 py-1 rounded-xl shadow-inner">
            <span className="text-purple-400 text-xs">✨</span>
            <span className="font-mono text-[11px] sm:text-xs font-black text-purple-300">
              {dust.toLocaleString()}
            </span>
            <span className="font-mono text-[9.5px] font-extrabold text-purple-400/90 tracking-tight">
              DUST
            </span>
          </div>
