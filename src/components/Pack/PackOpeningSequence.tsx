          ...
          >
            ...
            <div className="relative w-full h-full rounded-2xl border-2 border-pink-400/50 bg-black p-4 flex flex-col justify-between overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center text-center bg-black/85 backdrop-blur-md py-2 px-2.5 rounded-2xl border border-white/20 shadow-2xl mb-1.5 w-full overflow-hidden">
                <h3 className="font-serif text-[14.5px] sm:text-[16px] font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-purple-200 to-amber-200 drop-shadow-md whitespace-nowrap truncate max-w-full">
                  {pack.name}
                </h3>
