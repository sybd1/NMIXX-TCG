...
export const PATCH_NOTES: PatchNote[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      '게스트 유저의 데이터는 저장되지 않으며, 소셜 로그인 연동 시에만 클라우드 영구 저장 및 랭킹 등록 활성화',
      '닉네임 변경 시 중복 검사 시스템 도입 및 새로고침/재접속 시에도 영구 보존되도록 동기화',
      '글로벌 랭킹 화면 정돈 및 교환소 시스템 임시 비활성화(보류)',
    ],
  },
  {
    version: 'v1.6.0',
  ...
  },
  {
    ...
    changes: [
      'Blue Valentine 세트 카드 nmixx_303(설윤)의 이미지 경로 대소문자 불일치(/cards/card_303.webp) 수정 완료',
